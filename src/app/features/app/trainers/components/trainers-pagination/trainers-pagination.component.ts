...
@Component({
  selector: 'app-trainers-pagination',
  templateUrl: './trainers-pagination.component.html',
  styleUrls: ['./trainers-pagination.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TrainersPaginationComponent {
  @Input() state: TrainersPaginationState = { page: 1, pageSize: 10, total: 0 };
