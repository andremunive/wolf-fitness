...
export interface VentasPaginationState {
  page: number;
  pageSize: number;
  total: number;
}
...
@Component({
  selector: 'app-ventas-pagination',
  templateUrl: './ventas-pagination.component.html',
  styleUrls: ['./ventas-pagination.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class VentasPaginationComponent {
  @Input() state: VentasPaginationState = { page: 1, pageSize: 10, total: 0 };
  @Input() itemLabel = 'ventas';
