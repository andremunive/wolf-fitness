...
import { UpgradePlanConfirmModalComponent } from './components/upgrade-plan-confirm-modal/upgrade-plan-confirm-modal.component';
...
@NgModule({
  declarations: [
    ...
    UpgradePlanConfirmModalComponent,
